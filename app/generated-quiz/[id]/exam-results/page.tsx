...
const ExamResults = () => {
    ...
    const fetchResult = async () => {
      try {
        ...
        setResultData({
          ...
          documentName: data.documentName || 'Exam',
  ...
  const getGradeText = () => {
    ...
    if (percentage >= 70) return { grade: 'B', text: 'Well done!' };
    if (percentage >= 60) return { grade: 'C', text: 'Good effort!' };
    if (percentage >= 50) return { grade: 'D', text: 'Keep practicing!' };
    return { grade: 'F', text: 'More study needed!' };
  };
  ...
  const handleDownloadResults = async () => {
    await downloadQuizResult({
      documentName: documentName || 'Exam',
    ...
    <div className='min-h-screen bg-white px-4 md:py-20'>
      <div className='max-w-4xl mx-auto space-y-8'>
        ...
        <div className='text-center space-y-4'>
          ...
          <h1 className='text-4xl font-bold text-gray-800'>Exam Complete!</h1>
          <p className='text-xl text-gray-600'>Here are your exam results</p>
        </div>
        ...
        <div className={`rounded-2xl border p-8 ${getScoreBgColor()}`}>
          <div className='text-center space-y-4'>
            ...
            {/* Time Information */}
            {(timeSpent || totalTimeAllowed) && (
              <div className='flex justify-center items-center gap-6 mt-6 p-4 bg-white rounded-lg'>
