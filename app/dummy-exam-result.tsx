...
//   const { quizId, documentName, questions, clearQuizData } = useQuizStore();
//   const { selectedOptions, isCompleted, getScore, resetExam } = useExamStore();
...
//     if (quizId !== quizIdFromUrl) {
//       router.push(`/generated-quiz/${quizIdFromUrl}`);
//     }
//   }, [quizId, quizIdFromUrl, isCompleted, isInitialized, router]);
...
//   const { correct, total, percentage } = getScore(questions);
...
//             You completed the exam: <strong>{documentName}</strong>
//           </p>
//         </div>
